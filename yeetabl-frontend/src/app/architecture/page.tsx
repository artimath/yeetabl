    ...
    <DashboardLayout>
      <div className="container mx-auto px-4 py-8">
        ...
        <h2 className="text-2xl font-bold mb-6">
          Segment Event Threshold Monitoring System: Architecture Overview and Cost
          Analysis
        </h2>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p className="mb-4">
              We used Cloudflare&apos;s workers platform to build a serverless system that
              can scale up to billions of events per day, and scale down to zero, while
            ...
            <p className="text-sm text-muted-foreground">
              Sequence diagram showing the flow of data and operations in our
              architecture.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            ...
            <ul className="list-disc pl-6 mb-4">
              <li>
                <strong>10,000 events per day (300,000 per month)</strong>: $0 (Included
                in free tier)
              </li>
              <li>
            ...
            <p>
              These estimates are based on current Cloudflare pricing. Batching 2000
              events per call significantly reduces costs. Actual monthly costs may vary
              based on processing complexity and event volume.
            </p>
            <p className="mt-2">
